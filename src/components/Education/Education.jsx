  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="hidden sm:block absolute left-1/2 top-0 -translate-x-1/2 w-1 bg-purple-500 h-full"></div>
        ...
        {education.map((edu, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="hidden sm:flex absolute left-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-gray-400 border-4 border-[#8245ec] justify-center items-center z-10">
                <img
                  src={edu.img}
                  alt={edu.school}
